...
namespace spu::mpc::cheetah::_yacl {
  ...
  void renew_ks(__m128i* new_keys, int n) {
    ...
    switch (n) {
      ...
      case 4:
        ...
        break;
      case 5:
        yc::AES_opt_key_schedule<5>(keys, scheduled_key);
        break;
      case 6:
        yc::AES_opt_key_schedule<6>(keys, scheduled_key);
        break;
      case 7:
        yc::AES_opt_key_schedule<7>(keys, scheduled_key);
        break;
      case 8:
      ...
      default:
        throw std::invalid_argument(
            std::string("MITCCRH:renew_ks not implemented: ") +
            std::to_string(n));
    }
  }
  ...
  */
  ...
  void hash_exp(__m128i* out, const __m128i* in, int n) {
    ...
    switch (n) {
      ...
      default:
        throw std::invalid_argument(
            std::string("MITCCRH:hash_exp not implemented: ") +
            std::to_string(n));
    }
  ...
  void hash_single(__m128i* out, const __m128i* in, int n) {
    ...
    switch (n) {
      ...
      case 4:
        ...
        break;
      case 5:
        yc::ParaEnc<5, 1>(out, scheduled_key);
        break;
      case 6:
        yc::ParaEnc<6, 1>(out, scheduled_key);
        break;
      case 7:
        yc::ParaEnc<7, 1>(out, scheduled_key);
        break;
      case 8:
      ...
      default:
        throw std::invalid_argument(
            std::string("MITCCRH: hash_single not implemented: ") +
            std::to_string(n));
    }
